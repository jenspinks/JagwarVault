...
| **Riddle-construction** | ✅ **REAL** (rare) | The 2023-02-09 X post is a 4-part numbered riddle whose answers concatenate to the known code **`ELEPHANT TORTISE EAGLE ATLAS`** — *including* the deliberate misspelling "Tortise." Proof that Roy builds some codes as multi-part riddles/word-chains, not just verbatim lines. |
