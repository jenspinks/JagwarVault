...
citable: true
status: stable
verified_against: ["Spotify track page — Lyrics (Jen screenshots, 2026-05-30): full song (top + back half)", "AZLyrics (initial ingest 2026-05-16, superseded)"]
ingested: 2026-05-16
ingest_source: "AZLyrics.com (pasted by Jen); verified against Spotify 2026-05-30"
---
# Another Way II Heaven — Lyrics (Source)

Verbatim ingest. **No interpretation here** — analysis lives in Brain/ and Essays/.

## Source
- **Album:** *33* (2022, Big Loud Rock) — **track 8 of 10**; 4:25.
- **Writer:** **Roy English (sole writer)** — confirmed via Spotify Credits (Pauling produces, not a writer); see [[Sources/Credits/33]].
...
*(Verbatim per Spotify; stylized quotes/caps preserved — "I", "You", "Us", "One, become Two", Self, Time, Door, Heaven, The Great Design.)*
