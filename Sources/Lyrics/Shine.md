...
## Maintenance
- Ingested 2026-05-16 (AZLyrics); **verified against Spotify 2026-05-30 (Jen screenshots) → `status: stable`.** Spotify supersedes AZLyrics. **Notable correction (CONFIRMED):** the line is *"**Gender** of my generation."* **AZLyrics *and* Apple Music render it wrong as *"Jenner of my generation"*** — a meaningfully different word. **Confirmed "Gender" by Spotify + Jen's ear (2026-06-02);** the line is about gender/identity, not the Jenner surname. Hedge closed — safe to build on. Other fixes: "we can start today" (not "could"), "It's like an earthquake" (not "Feels like"), "goin… getta outa hand," "upper hand," "the sun is coming out singing." `[?]` writer credits not re-screenshotted.
