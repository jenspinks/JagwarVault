...
- **Roy's actual quote** (*"…the miracles of yesterday's dreaming. The realist crucifies genius…"*) — two **unconfirmed** candidates: **Herbert Kaufman's prose-poem "The Dreamers"** (strong thematic fit — dreamers crucified-then-immortalized; Kaufman is a verified "dreamers" author) and **R.G. Ingersoll** (*Works* Vol. 3, idealism-vs-realism; one phrase-index hit). **Neither verbatim-confirmed** — *my earlier "Ingersoll [W]" was over-confident and is withdrawn to `[?]`* (same failure mode as the Russell pin: a search-match not confirmed in the text). Pending a primary-text pin (Jen taking it). Text truncated in capture.
