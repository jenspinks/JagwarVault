...
- **[06-15]** *"All commonplace realities of to-day are the miracles of yesterday's dreaming. The realist crucifies genius, reaps the fruit of his vision and then immortalizes him. Down through all time great ideas have been universally condemned at birth. Prophets, philosophers, saints,"* → [[The Pattern]] / [[Inversion]] (the prophet-crucified-then-immortalized arc; retells the [[Soul Is A Star]] verse, posted ~9 months after the song). **Attribution — CORRECTED (2026-06-14):** likely **Robert G. Ingersoll** (*The Works of Robert G. Ingersoll*, Vol. 3 — his idealism-vs-realism argument, prob. the *Shakespeare* lecture). A **clean phrase-search** ties *"the realist crucifies genius / reaps the fruit of his vision"* to that volume, and the surrounding logic matches (*"realism degrades… a realist can be no more than an imitator and copyist," "take refuge in the real, hiding a lack of genius"*). `[W]` — distinctive phrases match Ingersoll; exact lecture/verbatim not fully pinned this pass. **NOT Walter Russell** — the earlier "Russell / *The Universal One*" attribution was a **mis-attribution**: it entered as a Fable-pass *stylistic guess* (STF Deep Dive **F16**: "reads like the Russell orbit" + Russell-is-on-the-"I'm 33"-board), then got over-claimed as "[G], confirmed via scan" in an external handoff — both **withdrawn**. (Russell *is* a real board influence, which is exactly why the wrong guess fit — a plausible-pattern-match near-miss; it **never reached canon**.) Implication: **this is NOT a "second Russell receipt"** — Ingersoll isn't a shown Roy influence, so the post is Roy curating a found quote (source now ID'd, pending exact-lecture confirmation). Text truncated in capture.
