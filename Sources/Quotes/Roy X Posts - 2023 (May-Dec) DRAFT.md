...
- **Roy's actual quote** (*"…the miracles of yesterday's dreaming. The realist crucifies genius…"*) — best read **`[S]`: echoes Herbert Kaufman's prose-poem "The Dreamers" (1910)** on two independent grounds — **theme** (dreamers as the source of the later-commonplace; the realist as antagonist; "makers of empire") **and Kaufman's signature reversal device** (*"All commonplace realities of to-day are the miracles of yesterday's dreaming"* = the commonplace↔miracle / today↔yesterday inversion that is his trademark "Kaufmanism"). **But the exact wording returns ZERO hits anywhere** — so it is *not* a cleanly-circulating quotation, and ⚠ **the vault's captured text may itself be a past-session summary/paraphrase, not Roy's verbatim post** (this line was captured *"text truncated"*; that's likely *why* nothing matches). **NOT Russell** (the genuine Russell line is the separate p.10 quote, above); **NOT** James Allen's *"dreamers are the saviours of the world"* (a known confound). *My earlier "Ingersoll [W]" is withdrawn.* **Decisive test still owed: re-capture Roy's RAW 2023-06-15 post (verbatim) → then check Kaufman's full "The Dreamers" against the true text.** Hold `[S]`.
