...
citable: true
status: draft
verified_against: ["Jen firsthand attendance-report relay (2026-07-27, session cb88ebe2)", "Fan IG posts tagged jagwartwin, location-tagged Paradise City Korea: @crownsondo carousel (~19h old at capture 2026-07-27 10:04), @music.fleamarket.club (verified) reel + repost", "@jagwartwin official IG Stories, 2026-07-27 (~4h old at capture): reposts of @nouserinformationlol and @bekimwj (Jen screen recording translate.mov)", "Frame checks by Claude 2026-07-27 against Jen's capture archive: IMG_2358-2369.PNG, SoulisaStar.PNG, translate.mov (in ~/Claude/Code/Images, outside the vault)"]
ingested: 2026-07-27
ingest_source: "Jen firsthand + her screenshot/screen-recording captures of fan posts and the official account's Story reposts; relayed in chat and frame-checked in session cb88ebe2"
...
**Primary observation record.** First-ever Jagwar Twin performance in Korea, and per Jen the first ever full musical set performed as Sir Lucius (distinct from the March 2026 premiere-speech appearance and the LA Live Underground filming events). **No interpretation here**, readings live in Brain/ and Essays/ (working draft: [[Essays/_drafts/fold-inbox/2026-07-27 Lucius live debut Korea - the intentional-frame formulation (session cb88ebe2)]]).

Jen's standing rule preserved: staging/action facts are `[P]` (firsthand relay) or ✅ (frame-verified against captures); **facial expressions and conveyed feelings are interpretation** *(interp.)*, not staging fact.
...
## Set (order as Jen recalls it, `[P]` recall, order = TO VERIFY)
...
- [ ] **What Lucius actually said in Korean.** ⚠ **Do not re-attempt on `translate.mov`** — resolved 2026-07-27 that its only intelligible speech is a **near-field audience voice**, and the three far-field windows yield nothing but Whisper's stock Korean hallucinations (다 그렇더라구요, 하나님, repeated 도연). **His words may not be present in this clip at all.** The path forward is **different footage** (shot near the stage, or a front-of-house/board feed), not further processing of this one. A Korean-speaking listener on *better* audio closes it.
