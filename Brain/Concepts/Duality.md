...
[W] **The *serve*-hinge — the duality rendered as one verb.** Both poles of the [[Lucius Lullaby (album)|Lucius Lullaby]] arc command *service*; they differ only in its **object**. Lucius's bargain ([[Brain/Songs/Lucius Lullaby|Lucius Lullaby]]): *"you gotta **serve** somebody"* (an allusion to Dylan's *"Gotta Serve Somebody,"* whose thesis is *you WILL serve; the only question is whom*). Roy's resolution: *"my mind must **serve** my heart"* / on his body, *"in **service** to all, in service to the one."* So integration is **not the refusal of the bargain but the same bargain answered in its own grammar** — the servant (the mind) reassigned from the external master (metric, money, fear, Lucius) to the internal source (the heart). The redirection of service, not its abolition, *is* the correct ordering this page names — and the firewall holds **even if the Dylan allusion is never grounded by a credit**: the *structure* is the point, service is constant, only its object moves.
