...
> **★ The three steps are a test of structure, never of statement `[W]` (2026-08-01, [[Brain/Concepts/The Cosmos]] §3).** Because Roy defines the figure as *"only tells the truth, but the truth can be deceiving"* `[G]`, a Lucius who **admitted** *"I'm just a mirror"* would be saying something literally true and the truth would do the deceiving: the disclaimer would license everything after it. So *does-it-admit-it-is-a-reflection* cannot be applied by listening to him. Two **behavioral** discriminators outrank it, and neither can be spoken: **orientation** (does the mirror face its source, or stand with the light at its back) and **self-effacement** (Roy's own stated method, *"getting out of the way and having someone else see themselves"* `[G]`, and the Empty Mirror's clean glass that adds nothing of its own). ⚠ And note the floor this rests on: **reflecting is not a diagnostic property of anyone** — the heart itself is *"the mirror of the Sun"* on Roy's board, and being a mirror is the vocation Roy claims for himself.
