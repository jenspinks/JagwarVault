...
## 2026 — C. G. Jung (public, named — *signs vs. symbols*)

- **[~2026-06-07]** Roy posts a photographed page of **Jung's *Collected Works* vol. 18** ("The Significance of Dreams," ¶416–417 — the **signs-vs-symbols** distinction) to his **Instagram Story, soundtracked to his own song [[Brain/Songs/Singles & EPs/The Watchers|The Watchers]].** The passage's worked example runs **evangelist-animals → the vision of Ezekiel → the Egyptian Horus and his four sons → the wheel and the cross.** This is the **first direct, public Jung sourcing** — it **promotes Jung from unnamed substrate (Resonance) to a named, captured influence** (parallel to Bailey). Roy is endorsing Jung's *method* (*"a symbol means more than it denotes… the mind is finally led towards ideas of a transcendent nature"*) — i.e. the symbolic-reading approach the vault itself uses. — (none — Instagram Story, @jagwartwin verified; [[Sources/Quotes/Roy IG Story - Jung Signs vs Symbols (The Watchers)]]). **Scope discipline:** grounds Jung-as-named + the *signs-vs-symbols* method + the Horus/Ezekiel/tetramorph cluster (paired to [[Brain/Songs/Singles & EPs/The Watchers|The Watchers]]); it does **not** auto-ground every Jungian doctrine (shadow/anima/individuation) — raise their floor, don't flip them all to grounded.
...
- Steiner / Dweller on the Threshold — does Roy name Steiner? [[The Dweller on the Threshold]] essay treats the Steiner doctrine as Resonance; verify if Roy ever cites Steiner directly.
