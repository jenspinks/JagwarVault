...
- [W] **The clown before the Circus.** Chaplin = a clown/persona figure speaking *against* mechanization → historical inversion of the later Circus: the clown waking the crowd into agency vs the Ringmaster synchronizing it for spectacle ([[Welcome to the Circus]]).
