...
referenced_by: [CONCEPT-TheLaborsOfHercules, SONG-BALLERINABOY, SONG-WelcomeToTheCircus]
...
- [x] ~~Which song is refused for NYH~~ **RESOLVED: [[SOL]] ("The Song of Love"), in EP2.** SOL is overridden again for [[Welcome to the Circus]] in EP3 — two beats.
...
- [x] ~~Ballerina-Boy moon line = female voice~~ **CONFIRMED:** the whole BB outro (incl. moon line) is an **older motherly female voice** (Jen, audio) → see [[Mary]] / [[Ballerina Boy]].
