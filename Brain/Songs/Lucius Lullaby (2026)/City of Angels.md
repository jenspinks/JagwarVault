...
- Only agentive line: *"I said hello."*
- **"The gods" = British-theatre slang**, topmost/cheapest gallery [G idiom].
- EP6 Lucius: *"I can't be stopped… my lullaby is everywhere as we speak"* (verified Jen 2026-06-07; cite EP6 video per Boundaries).
- Board tab **"How to upload myself to the internet"** ([[Sources/Artifacts/Roy - I'm 33 this year (spreadsheet)]]).
- Board: *"One become Two… one day We'll get back together and see The Great Design"* ([[The Pattern]]).
- Visualizer blocking: [[Sources/Reference/Playing to the Gods Visualizer (choreography)]] (Jen 2026-06-17).
- Artifact *Jupiter the Blue Dolphin*, code `LADDER` ([[Artifacts - Drawings and Sketches]]).
...
- **Rotation may over-read** ordinary pop address-shifting; the Loop is *encodable*, not proven. `[W]`
- **Resonance-stack depth risk:** four traditions on one walk; prune, rest = reader's-intertext. `[~]`
- **Falsifier:** Roy framing it as straight fame-cautionary demotes the apparatus to overlay; rabbit-bride stays `[?]`.

## Sources
Lyrics: [[Sources/Lyrics/City of Angels]] · [[Sources/Lyrics/Playing to the Gods]] (Apple-verified). Credits: [[Sources/Credits/Lucius Lullaby]]. EP6: [[Sources/Transcripts/The Interview (Roy vs Sir Lucius, theatrical EP1-7)]]. Board + visualizer cited above. *No private material. No Bailey claim. Google Docs not cited.*

> **Full reading:** [[Essays/Concepts/Songs/City of Angels]]
