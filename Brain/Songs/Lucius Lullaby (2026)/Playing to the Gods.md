---
id: SONG-PlayingToTheGods
type: song
status: stable
confidence: medium
source_quality: primary-source
sources: [Sources/Lyrics/Playing to the Gods.md, Sources/Credits/Lucius Lullaby.md]
related: [SONG-CityOfAngels, CHAR-SirLucius, ALBUM-LuciusLullaby, CONCEPT-TheCircus, CONCEPT-TheLoop]
connections:
...
referenced_by: [SONG-CityOfAngels]
dominant_pole: lunar
...
active_systems: [Spectacle]
active_symbols: [Fire]
review_date: 2026-12-07
---
# Playing to the Gods

Type: Song — **Track 9**, the **seed-mantra** of the seamed pair it opens; **track 10 [[City of Angels]]** is the temple that absorbs it (Jen heard them live as one song — same device as 1→2). Writers: **Matthew Pauling, Roy English**.
