...
**Punctuation (Jen's standing preference): never use an em-dash `—` where a comma would work.** Default to the comma (or a colon, or parentheses). Reserve `—` only for genuine hyphenated / compound words. This applies to vault pages and to chat replies alike.
...
**★ Heart / soul / spark / higher self — Jen's ruling (2026-07-31) `[P]`.** Roy uses these **interchangeably**, and *usage defines the term more than the word does*. Treat them as one referent for simplicity; do **not** stage "mind serves soul" vs "mind serves heart" as a contradiction (the board's rung 6, *"The mirror of the Sun and the Heart,"* strengthens the identification: the heart is where source-light lands). **Flag only when one of these words is used in a genuinely DIFFERENT way** — that is the exception worth catching. Never rewrite Roy's own word inside a quotation. ✅ **The live consequence is now settled (2026-08-01, [[Brain/Concepts/The Cosmos]]).** Yes: if the heart is a *mirror*, the reflector-role stops being diagnostic of Lucius, **and that is the finding, not a problem.** Everything in this cosmos that is not the Sun is a mirror, on Roy's own five dated statements plus this rung. What separates them is **living versus captured orientation** (what a body takes its bearings from, a relation and not a head-angle), **release-and-return versus orbit**, and **a living sky versus a manufactured local source**; plus **self-effacement** (Roy's stated method, *"getting out of the way"*). *Claim* is a test of **structure, never of statement**, because a Lucius who admitted mirrorhood would be telling the truth deceivingly. ⚠ **Neither figure is a celestial body.** Roy = the **heart** who can become a faithful mirror (his lunar reading is a *mode*, retired as an allocation); Lucius operates the **machine-Moon**; the Sun is **shared and born inside**. ⚠ One attribution to hold: ***"im just a mirror"* is ROY's line, not Lucius's** ([[Claim Ledger]]). Dossier retired: [[Essays/_drafts/BREAKOUT - Is Lucius the moon (light, mirror, and the counterfeit sun) 2026-07-31]].
...
**★ Attribute board text to its SOURCE, not to Roy (standing instruction, 2026-07-31).** The "I'm 33" board is a **commonplace book**: much of its prose is **copied from books Roy was reading** — Dion Fortune, **Gray (*The Ladder of Lights*)**, **Gareth Knight**, **Lévi**, the Kybalion, Walter Russell, Besant & Leadbeater, Carroll. A board cell is `[G]` evidence that **Roy selected and kept** the passage; it is **not** evidence he wrote it. Never head a board quotation "Roy's own statements" unless the hand and the phrasing are his. **The selection is the authored act** — which is a *stronger* reading, not a weaker one (it makes the board a curated instrument library). Applies equally to pasted artworks and quote-cards.
