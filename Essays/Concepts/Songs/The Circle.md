...
> **Source discipline (do not over-collapse; do not over-ground):** the three names stay a **family resemblance**, not an equation — *Marian vessel / Gnostic Sophia / Kabbalistic Shekinah* — and the Wise One's defining act (**remembrance**) is **more Sophia/Shekinah than conventional Mary** (CLAUDE.md §register-collapse). *"Inside of the Inside"* is **an AI-generated dossier — NOT a podcast.** Gemini mislabeled it a "podcast" and quoted AI-synthesized text (*"blue jeans / California corner / ABC,"* the Binah/Shekhinah mappings) as if it were a real transcript — a **circular-AI-citation trap.** Per the vault rule, AI dossiers are **`citable: false` finding-aids: trace the primaries they name, never cite the dossier;** its "quotes" are **unverified AI output**, not Roy, not even reception. The *"Themes, Parallels" doc* is likewise a finding-aid. **Neither is authorial grounding** — the readings above stand on the **public lyric** + existing canon.
