...
- **[W] Two ends of one arc.** *Woodstock* = the boy at dawn walking to "get my soul free." *Soul Is A Star* = the same soul after "the world took him" — "wrote songs you never heard… gave it up before Prophets ever turned." The hinge is Woodstock's own "caught in the devil's bargain." *(⚠ attribution contested — that line may be CSNY's, not Joni's original; verify vs jonimitchell.com, see §XIII.)*
...
- **[?] "caught in the devil's bargain" — CONTESTED, verify before relying on §III's "hinge."** A Joni research dossier ([[Sources/Reference/Joni Mitchell — JT-relevant analysis (research dossiers)]] Part 3) claims that line is **Stephen Stills's CSNY alteration, not Joni's original** (which it gives as "we are billion year old carbon"). **But** our captured Woodstock text ([[Sources/Reference/Joni Mitchell - Ladies of the Canyon (reference)]]) includes "Caught in the devil's bargain," and most sources show Joni's *Ladies of the Canyon* recording has *both* lines. **Verify against jonimitchell.com.** If it turns out CSNY-only, §III's "Woodstock's own darkest line" hinge must be softened (it'd be CSNY's line, not Joni's).
