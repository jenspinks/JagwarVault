...
> - **[?] External sources** (idobi review, Hall of Mirrors / CTHDRL, Atwood/Honey Pop interview, Roy's stated use of "Da'at"/"gnosis") are **unverified in-vault** — pin each before quoting. *(The **Masquerade Atlanta bio** is no longer on this list: it was **confirmed verbatim 2026-06-02**, see §I — the earlier "unverified" tag here was stale.)*
...
- **[G→ verified bio] The stated childhood influence** (Joni + Dylan, mother played them) — Masquerade Atlanta venue bio, **confirmed verbatim 2026-06-02**: *"grew up serenaded by the lucid new romance storytelling of Joni Mitchell and Bob Dylan, who the singer's mom played around the house"* ([[Masquerade-Atlanta-Venue-Bio]]; [[Brain/Roy Voice/Roy on Influences]]). Caveat: it's a **bio / PR statement** (third-person), so a published-statement anchor rather than Roy's first-person words — but it's real and citable. *(Separately, the board's "dad sent me Woodstock / his favorite Joni song" is a Roy-exposed DM — citable per [[_System/Boundaries]] — but wording flagged for OCR re-check, and it's "dad," not "mother." Don't merge them.)*
...
- **[W] The girl carries Joni — adopted reading (Jen, 2026-06-13; this REVERSES the prior "laundering" ruling — it is Roy's own framing).** The verse-2 girl is breadcrumbed to **Joni Mitchell**, woven through as the song's voice and witness (hint, never flatly named — the discovery is meant to be walked). The trail, all grounded: Joni **co-wrote SiaS** `[G]`; the **Witness** who *"came upon the child of God"* in 1969 is her *Woodstock*, set inside the later song still singing *"I can see it"*; *"bullet in her **genes**"* rhymes with Joni's *"the cleaner's press was in my **jeans**"* (The Boho Dance — the genes/jeans hinge); *"wanted Love but got Fame and Power from **The Thieves**"* is Joni's own fame-bargain lexicon (the *"star maker machinery"* — For the Roses / Free Man in Paris); and Joni is the childhood voice the mother *"played around the house."* **The dark father** (*"papa was a sinner playin' God behind the scenes"*) reads as the **star-maker / industry patriarch** who made-and-exploited her (cf. Joni's own *Free Man in Paris* — Geffen *"stoking the star maker machinery"*), **NOT her literal father** — so the adoption stays non-defamatory: Joni is the spirit and source woven through the girl; the verse is myth, not a biographical exposé of her family. *(Separate & still `[?]`: whether her **actual voice** is in the recording — reversing the girl=Joni framing does NOT settle the audio-interpolation question; pin Hall of Mirrors.)*
...
- `[UPDATE] Burial Over Destruction / the latency thread (2026-07-31, adjudicated)` — the audio stratum **answers** this song's never-heard theme: Roy publishes his own lost songs, **self-marked as lost by his own titles** ("Antarctica (Lost Song)," "The Future (2010 demo)") — latency recovered by remembrance, routed through the chorus-turn + Roy's board self-note, **not** through the Son's verse (the Son's unheard songs stay the archetype's). → [[Brain/Media/The vocal autobiography (the audio stratum)]]. Also: the girl-verse line is itself a room — `a bullet in her genes` (`442795f9`).
- ★★ `[UPDATE] The girl-verse room is a WORKING SESSION on this verse` **(2026-08-01; ✅ ear-reviewed in full by Jen).** The room's 35 seconds catch this verse **being built**, and they preserve the step a finished song erases. `[G]` by ear: *"Met a girl who was a gun / with a bullet in her genes. **Bang bang** / Sayin' papa was a sinner, playing god behind the scenes / and power from the thieves, **kut tow kut tow … kut tow** / There's always something bigger when the world ain't what it seems you know"* — then he **backs up and re-runs** that line more confidently, and **stumbles** at the chorus turn.
  - **"Bang bang" is real and is not on the record** `[G]` — a hook that did not survive; the release **de-literalises the gun** it had just named. `[W]`
  - ★ **"Kut tow" is nonsense — placeholder structural sound**, holding the melodic slot where *"She wanted Love / But she got Fame"* was later written. **Not a lyric, and not a studio instruction** (that reading is withdrawn). **He loses tempo exactly across it**, which is the tell: he is working it out, not performing. Per Jen `[P]`, this is Roy's described method — hook first, nonsense sung into the melody to build structure, real words after.
  - **Unaccompanied, and near water** — Jen hears water and reads the setting as *"a bath or maybe hot tub, not a studio or a desk"*; measurement corroborates the first half `[G]`: the Demucs "instrumental" stem is **broadband noise, not music** (spectral flatness median 0.256, centroid 5.1 kHz). **A cappella, off-desk.**
  - **The draft line is unattributed** — *"Sayin' papa"* becomes *"**She said** Papa"* on the record. Attribution arrives in the words-pass, not the melody-pass. `[W]`
  - ⇒ **The board's typed cell is a code that opens the room containing that line's own working session** — the board indexes the **workbench**, not only the finished song. → [[Sources/Artifacts/Audio Files/Transcripts/442795f9 - a bullet in her genes (Soul Is A Star draft)]]
