...
**A note on the word (settled 2026-07-16).** The word is **"tame"** `[G]` — confirmed with Jen. Apple Music's Lyrics tab mis-transcribes it as *"pain"*; that is an **Apple transcription error**, not a variant reading. It matters because *tame* is the load-bearing verb of the Leo / Strength reading: integration through direct contact, never destruction at distance. *(An earlier note here read Apple's "pain" as a pun on **"pane"** — a pane of glass, the mirror — and routed it to the same integration meaning. That reading is **withdrawn**: it rested on a third-party mis-transcription, not on anything in the song. Record: [[Sources/Lyrics/Not Your Homie]].)*
