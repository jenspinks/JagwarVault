...
- **Placement & credits:** Track 11 on [[Lucius Lullaby (album)]]; pre-album single, **released October 31, 2025**. Credited artists: Jagwar Twin, **MERCY**, and Sir Lucius. The credit itself matters — Lucius is named as a *co-maker inside the system*, not a costume. The writing/production credits are now verified (Qobuz, corroborated by Apple/Shazam): written by **Roy English, Mercedes Colletta Britton, and David ("Dave") Burris**; produced by Jagwar Twin and Dave Burris; mixed and vocal-produced by Roy English; mastered by Dale Becker and Noah McCorkle.
- **⚠ Timeline guard — NYH does NOT *originate* Sir Lucius (Jen, 2026-06-28) `[G]` dates:** Lucius is a public figure independent of this song. Earliest X emergence **2025-11-07** (already carrying *"not your homie"* merch), the **STOP SIR LUCIUS** campaign ran publicly **03-26-2026**, and the premiere-speech video posted **03-23** — and NYH itself released **2025-10-31**. So NYH **stages a persona-hardening / boundary event** — the "I" refusing false kinship and hardening into a guarded border (per the one-line reading above) — it does **not** create or first-introduce the figure. Don't promote this song to Lucius's origin point; the figure's billing changed, not its existence.
- **MERCY / chorus origin [G]:** Roy, on release day (X, 2025-10-31): *"She literally sent me a joke voicenote singing this chorus after getting back from a party and I knew we had to make this a sir lucius song. The ultimate introverted extrovert anthem."* MERCY did not merely co-write the song — she **originated the title and chorus hook**, delivered as an offhand joke after a party. The song's central gesture (the "not your homie" refusal) came from her, not Roy. Roy's own framing — *"the ultimate introverted extrovert anthem"* — grounds the mask-of-extroversion reading directly: Lucius is Roy's socially functional performance over the introverted self underneath. ([[Sources/Quotes/Roy X Posts - June 2026 (aphorisms)]] 2025-10-31.)
...
- **Biographical grounding `[W]`:** Roy states the **champion ethic** in his own voice — *"be willing to fight for it. Even if that means 'losing' in the short term"* ([Discord, 2023-11-19](https://discord.com/channels/705391219915882516/709750776284708955/1175934696652288121), drawn from being dropped by Warner/Atlantic). *"Prove yourself to be a champion"* is **lived** — the fight-even-at-cost the [[Sources/The Game/Gatekeeper Saga (dumbledore)|gatekeeper saga]] documents.
...
**A note on the word (2026-07-15).** Streaming sources diverge here: **Spotify reads *"tame,"* Apple reads *"pain."*** The ambiguity deepens the reading rather than weakening it. *Tame* is the Leo / Strength verb: integrate through direct contact. *Pain* — heard the way Roy hears his own homophones (dog/god, El Roi/El Roy) — is a pun on ***"pane,"*** a pane of glass, **the mirror**: to *pane the Beast* is to hold it up to the glass and *see* it, which is the project's core operation (*"we are all mirrors,"* the [[Concepts/The Empty Mirror|Empty Mirror]]). Both verbs land in the same place — **the Beast is reflected and integrated, never destroyed.** Jen confirms from direct discussion that Roy's intent is *always* integration/balance, never destruction, so the divergent word cannot flip the meaning; it only offers two routes into it. `[P]` (the pane pun) / `[W]` (the synthesis). *(Source divergence documented at [[Sources/Lyrics/Not Your Homie]].)*
...
- **Not every credit or name is mythology.** The MERCY feature looked like a symbol (Pillar of Mercy) and is biography: a real collaborator who **originated the song's chorus hook** (see Grounded above) — prominent billing because the contribution was generative. General guard: check the industry/biographical explanation before mythologizing a name, a credit, or a collaborator.
