...
> Generated by `node _System/gen-open-questions.mjs`; **regenerate after editing pages.** Each page's own `## Open Questions` section is the source of truth. Pass `--date=YYYY-MM-DD` to stamp. Generated: 2026-07-01.

**375 open questions across 101 pages.**
