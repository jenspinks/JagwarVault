...
| tier | n | status |
|---|---|---|
| A. LOOP war sequence (watched) | 4 | captured |
| B. Jen's ✅ from YT FLAG | 38 | promoted |
| C. KEEP-A, Roy's own words (YT) | 61 | keeper |
| D. KEEP-B, curated quote-cards (YT) | 70 | keeper |
| E. TikTok keepers | 49 | reviewed (2 ✅ = high-value) |
| F. TikTok FLAG keepers (your ✅) | 3 | reviewed |

## Set aside (not in the eval set)
- YT FLAG un-checked: **185** · YT DROP: **204** · YT catalogue: **136** · TikTok overlap-with-YT: **282** (already covered) · TikTok DROP: **11**.
- **TikTok pruned (Jen 2026-07-16):** §E kept 49 (removed 49 ❌); §F kept only 3 ✅ (all other F dropped).

## A. ★ LOOP-visualizer war sequence (4 clips, WATCHED 2026-07-15)
*One unit. All four are LOOP-campaign clips (Aug 2025) built from **Interview EP1** footage + symbolic imagery, captioned as a serialized "war" myth. Dialogue is already in the vault EP1 transcript; new capture = visuals. Chronological order:*
- `2025-08-02` [The waters stirred, and the war began ♱☯](https://www.youtube.com/shorts/3cZQNp2AX2I)  **you:** shows the magician card.  **watched:** crow → Roy/Lucius in white face-paint + two cheek-crosses under a lettered eared-harlequin hood, mirror-chamber; dialogue *"happy face, bad feeling. Every song they love, it was me."*
- `2025-08-06` [In the mist of infinity, Roy's prayer was heard ✟](https://www.youtube.com/shorts/5E-0GLFtnks)  **you:** the "not roy guy" appears — decided it's *supposed* to be Roy but is just bad 2025 AI (not a real second character).  **watched:** montage, all meant to be Roy — Roy in his gold grill screaming; Roy shirtless in a fog-filled parking garage (tattoos "FEAR"/"you're ALIVE", chain-and-cross); early hands-over-face + moonstone ring; a hazy blurred singing face (caption "I feel like I'm stuck in a loop") = the likely bad-AI "not Roy" artifact.
- `2025-08-07` [Roy's prayer was answered through a crack in the sky, and the fire still burned ✡☯](https://www.youtube.com/shorts/xLsnaMouE0o)  **you:** (was NOT ✅, added) opens with a fire explosion coming toward him.  **watched:** Roy in the gold grill, screaming.
- `2025-08-08` [The tree would not fall into the flames ✞☠](https://www.youtube.com/shorts/qERdFH-qNHs)  **you:** on the loop visualizer.  **watched:** a lone tree in a barren field, canopy made of flames, left standing.

## B. Jen's ✅ from YT FLAG (38)
### Thematic (11)
...
- `?` [Hey Deep Roy, I’m Shallow Roy](https://www.youtube.com/shorts/tf_XmCHxELw) _Duality/mirror, Duality_  **you:** Roy calls Bad Feeling his Shallow Roy song
- `?` [tooting my horn 🎺](https://www.youtube.com/shorts/m8faNjf1_iU) _Lucius/herald_  **you:** Roy is singing Good Time
- `2026-05-06` [If you feel like a mistake you must be mistaken - ROY](https://www.youtube.com/shorts/RdGUnBcBA8s) _Weirdness_  **you:** Weirdness is signed ROY not lucius
- `2026-04-14` [Almost all commercial bananas are genetically identical.](https://www.youtube.com/shorts/-QYrlRd8ydo) _Lucius_  **you:** Clones, genetic dead ends, beautiful but sterile.
- `2026-03-26` [Do you hear lucius’ lullaby?](https://www.youtube.com/shorts/PooRVksxDxY) _Lucius_  **you:** Why "Do you" and not have you or did you or just the command to hear in?
- `2026-02-13` [Every maze has a center](https://www.youtube.com/shorts/vfAAqcVzw58) _The Circus_  **you:** Just a short singing circus with the same character that plays mary dancing behind him.  has the SAME hebrew on her neck.
- `2026-01-15` [Visita interiora terrae, rectificando invenies occultum lapidem](https://www.youtube.com/shorts/pjNv1dFAdZg) _The Circus_  **you:** _**V**__isita_ _**I**__nteriorem_ _**T**__errae_ _**R**__ectificando_ _**I**__nvenies_ _**O**__ccultum_ _**L**__apidem_, alchemy
- `2025-10-13` [🦇🖤 sir lucius on your timeline telling you what to wear and what to like and how to be. 🖤](https://www.youtube.com/shorts/sljzclx4Jm8) _Lucius_  **you:** Lucius replaces the system
### Statements / video-content (24)
- `?` [The power of language and music](https://www.youtube.com/shorts/peZEkmJ77ws)  **you:** I think a lot of what triggered me becoming an artist was feeling the lack of a way to communicate what was going on internally, inside...externally.  struggling to find words that could actually articulate the way that I was feeling.  but words paired with music  was a whole different thing and you could express yourself in a different way and connect with other people  in a different way. and I think music has a really powerful ability to connect poeple because of that.  if you take happy face and you say "hey put on a happy face and everything ok" but it's over happy music it means something totally different then when its over strange clown circus music. Its this emotion thats beyond words, and thats something that so powerful that we can do as artists.
- `2026-06-29` [You don't make it out alive](https://www.youtube.com/shorts/6p1cKrL-Tgg)  **you:** on welcome to the circus visualizer
- `2026-06-17` [There is only now. Wya?](https://www.youtube.com/shorts/XUmOpkE3_Rs)  **you:** on the Underground Concert (Bounce)
- `2026-06-15` [This is our world](https://www.youtube.com/shorts/sNTNxOr9DIg)  **you:** bounce in the Underground Live show
- `2026-04-28` [Bless millie bobby brown her character 11 was top 4](https://www.youtube.com/shorts/ZSUcQ0SG9uI)  **you:** this is on the video for GttbH - there once was a girl who drank from the fountain...
- `2026-04-07` [I’m the No. 1 champion in this town](https://www.youtube.com/shorts/0hIdgMjIHAk)  **you:** plays trumpet along with opening to #1 champ
- `2026-03-16` [When the old order breaks the new world begins](https://www.youtube.com/shorts/o0We4jEE-4M)  **you:** Opening lyrics of banana "hy kids, do you ever wanna break shit"
- `2026-03-13` [Genesis 3](https://www.youtube.com/shorts/WNNdfSIP0Jg)  **you:** Lucius lullaby - when the first human beings started walking...
- `2026-02-06` [you’re welcome 🎪](https://www.youtube.com/shorts/BP-IZdXATAY)  **you:** Unseen woman hands lucius a phone - "Lucius, WttC is blowing up.  We need you to make a video thanking your fans for listening to it" Lucius - smoking. " well, I told you this would happen.  WttC is officially Jagwar twins highest performing song of all time.  So.  Your Welcome."
- `2025-10-21` [Are NPCs real?](https://www.youtube.com/shorts/lsAQM_FuyCo)  **you:** On NYH video
- `2025-10-20` [“The time has come to realize that supersensible knowledge has now to arise from the materialistic grave.”― Rudolf ](https://www.youtube.com/shorts/pM6lTMciQZQ)  **you:** Happy Face video "tik tok ticking like a time bomb. lines.
- `2025-09-15` [The world’s in flames 🐇](https://www.youtube.com/shorts/t8LjN-ZAPo8)  **you:** interesting because he put this song over the footage that had been being used for loop
- `2025-06-09` [to the whispers from the future not the echos from the past. It’s you. BALLERINA BOY out June 13th](https://www.youtube.com/shorts/CbnCOWhX-Z4)  **you:** ballerina boy and the writing "this is a reminder to love the person that you were as much as the person you are becoming."
- `2025-06-08` [What parts of yourself have you buried? No more walking with ghosts ☠︎ ✞](https://www.youtube.com/shorts/kfa4mcVVc0w)  **you:** Ballerina Boy video with text: " I buried the part of me that felt the most alive. This is his story."
- `2025-06-06` [The legend is me obviously](https://www.youtube.com/shorts/boJY6_j-S7Y)  **you:** Ballerina Boy video - Text on video: they told him he wasn't a real boy. so he became a legend instead.
- `2025-06-03` [Pinocchio Jesus](https://www.youtube.com/shorts/VmgCD3i4A34)  **you:** Ballerina boy text says - "what makes a real boy"
- `2025-05-30` [Anyone else a christian school kid?](https://www.youtube.com/shorts/jmE28-zNERs)  **you:** video says "The most dangerous thing you can be is yourself"
- `2025-05-22` [Ok dog](https://www.youtube.com/shorts/NYwH6HooFAU)  **you:** interviewer: are you more of a dog person as well? Roy: I'm more of like a human person.
- `2025-05-18` [Promo](https://www.youtube.com/shorts/XrrNoo9GHHs)  **you:** Magik - text Music for the fans of Jesus, the Buddah, and Harrry Potter
- `2025-04-15` [When’s the last time you watched Snow White tho?](https://www.youtube.com/shorts/oIoh-NUWZDo)  **you:** Interview video Roy: "Jagwar Twin, the whole thing is an exploration of light and dark. Carl Jung also has this quote" The taller the building, the greater the shadow. And so its like your capacity to hold truth, to hold light...if like you're a tall building, you're gonna have a deep shadow.  Everything with Jagwar Twin has this dual element. Its both and how they play together. Because that so much of my exploration as a human. Because the jaguar is the creature in myan mythology who goes into the dark places and knows that its powerful enough to then come out and bring other with him"
- `2025-03-25` [Shoutout to the council of Balder ⚡️](https://www.youtube.com/shorts/9t42QPfM_bY)  **you:** just flagging this because I don't remember if we have looked into balder's gate and what signifigance it might have
- `2025-03-20` [I'm a Gemini, but I identify as a Libra](https://www.youtube.com/shorts/NmzXh0yQy9A)  **you:** nothing black and white except for you cuz your a zebra
...
- `2025-02-21` [It is important to fight and fight again, and keep fighting, for only then can evil be kept at bay though never quite eradicated.⚔️](https://www.youtube.com/shorts/6FYRse0dCaI)

## C. KEEP-A, Roy's own words, YT (61) — **new** = phrasing not on a vault page
...
## D. KEEP-B, curated quote-cards, YT (70) — Roy's reading/influence list
...
## E. TikTok keepers (49) — your review; 49 ❌ removed; ✅ (2) = extra high-value
- `2026-06-23` [It’s difficult for god to hear you when you scream.](https://www.tiktok.com/@jagwartwin/video/7654645603024063775) _The Circus_
- `2026-05-28` [I’ll give you what you’ve been dreaming](https://www.tiktok.com/@jagwartwin/video/7645043971709750559) _Lucius, Sleep/WakeUp_
- `2026-04-17` [I saw her divinity, but not the one who held it, or where it led. I followed anyway, white rose in my left hand, an](https://www.tiktok.com/@jagwartwin/video/7629814203796278559) _Roy_
- `2026-04-02` [Nowhere is not a destination but you can arrive in an instant- Roy](https://www.tiktok.com/@jagwartwin/video/7624249827538373918)
- `2026-03-24` [“Everything is illusion (Maya) outside of eternal truth.” - H. P. Blavatsky](https://www.tiktok.com/@jagwartwin/video/7620897813693500702) _The Circus, Gnosticism_
- `2026-03-20` [“The universe is a mirror reflecting the image of the one who looks into it.” - Manly P. Hall “lucius lullaby”](https://www.tiktok.com/@jagwartwin/video/7619450772618611998) _Lucius, The Mirror_
- `2026-03-10` [“I would arrest anybody who uses the word ‘State’… and after a chance of recantation, execute them if they persist.](https://www.tiktok.com/@jagwartwin/video/7615699636866649375)
- `2026-02-25` [“The shoe that fits one person pinches another” - Carl Jung](https://www.tiktok.com/@jagwartwin/video/7610946324036455711) _Jung(res)_
- `2026-02-24` [“One does not become enlightened by imagining figures of light, but by making the darkness conscious.” - Carl Jung](https://www.tiktok.com/@jagwartwin/video/7610573156163603743) _Jung(res)_
- `2026-02-17` [In an interesting turn of events, ROY no longer seems to be interested in releasing . Instead he turns his attentio](https://www.tiktok.com/@jagwartwin/video/7607981950913023262) _Lucius, Weirdness_
- `2026-02-05` [“The shadow is not evil. It is power unrecognized and therefore misused.” - Dion fortune](https://www.tiktok.com/@jagwartwin/video/7603463455680613662) _The Circus, Lucius/shadow_
- `2026-01-07` [“people demand freedom of speech as a compensation for the freedom of thought which they seldom use.” - Kierkegard ](https://www.tiktok.com/@jagwartwin/video/7592418865984834846) _The Circus_
- `2026-01-05` [sir lucius’ plan in Episode 2 worked. “not your homie” is flying and success is undeniable. ROY wants to release hi](https://www.tiktok.com/@jagwartwin/video/7592028263640354079) _Lucius, The Circus, SirRabbit/Lucius_
- `2025-12-29` [I got dropped for this song. Now it’s my first Gold record. This is your reminder to trust yourself even when nobod](https://www.tiktok.com/@jagwartwin/video/7589363482001198367) _The Algorithm_
- `2025-10-31` [not your homie is ! Thank you to the amazing @MERCY for singing this and writing this with me. She literally sent m](https://www.tiktok.com/@jagwartwin/video/7567421820593376542) _Lucius, Roy_
- `2025-10-14` [Replying to @Dr_Pepper "All that you see out in front of you is how you feel inside your head." - Alan Watts](https://www.tiktok.com/@jagwartwin/video/7561133643205250359)
- `2025-10-09` [Replying to @Karo "The crowd neither wants nor seeks knowledge, and the leaders of the crowd, in their own interest](https://www.tiktok.com/@jagwartwin/video/7559267932832828702)
- `2025-09-15` [The world’s in flames 🐇 @angelbaby](https://www.tiktok.com/@jagwartwin/video/7550419098119802126)
- `2025-08-15` [But Lucius’ secret faction grew in the darkness and kept close eye on Roy. If you’re with Roy repeat below in the c](https://www.tiktok.com/@jagwartwin/video/7538888402247224607) _Lucius, Lucius/apple, Lucius/shadow_
- `2025-07-31` [The War begins Which side are you on? White hearts for Team Roy 🤍 Black hearts for Team Sir Lucius 🖤](https://www.tiktok.com/@jagwartwin/video/7533308235458153759) _Lucius_
- `2025-05-13` [I’m so excited to finally announce The Inner Circle. A secret chamber for the most loyal servants of the realm on m](https://www.tiktok.com/@jagwartwin/video/7504030600991427870)
- `2025-04-09` [Replying to @kidney “It is the unknown we fear when we look upon death and darkness, nothing more.” - Dumbledore, a](https://www.tiktok.com/@jagwartwin/video/7491416015008468254)
- `2025-04-01` [We rise by kneeling We conquer by surrendering We gain by giving up Go forth, loyal servants of The Realm ⚔️❤️‍🔥](https://www.tiktok.com/@jagwartwin/video/7488373612915772702)
- `2025-02-24` ["To repress rebellion is to maintain the status quo, a condition which binds the mortal creature in a state of inte](https://www.tiktok.com/@jagwartwin/video/7475088701136129311) _Lucius/Devil_
- `2025-02-11` [Replying to @Pam Swore an oath to protect the Realm ⚔️](https://www.tiktok.com/@jagwartwin/video/7470276794344607018)
- `2025-02-10` [Replying to @TypicalTabbyCat After many battles… the “problematic” dumbledore comes out FEB 28th. Loyal servants of](https://www.tiktok.com/@jagwartwin/video/7469911577404247327)
- `2025-01-15` [Went to the middle of the desert in Abu Dhabi with some friends, made a bonfire and sang The Circle under the stars](https://www.tiktok.com/@jagwartwin/video/7460214255296515370)
- `2025-01-01` [2024… infinity ♾️ you changed my life. Thank you for all the gifts. Thank you to every single one of you who came t](https://www.tiktok.com/@jagwartwin/video/7454738095498464543)
- `2024-12-23` [Life Is Good Dubai @angelbaby](https://www.tiktok.com/@jagwartwin/video/7451648658522656043)
- `2024-12-17` [Finished off an incredible year with one last magical show in Dubai. Thank you](https://www.tiktok.com/@jagwartwin/video/7449502711415967007)
- `2024-11-26` [More shows in 2025 @angelbaby @Big Loud Rock](https://www.tiktok.com/@jagwartwin/video/7441665829994892586)
- `2024-09-27` [Replying to @Chalametnator lore shadowing](https://www.tiktok.com/@jagwartwin/video/7419394865114434859) _Lucius/shadow_
- `2024-09-23` [Who are The Watchers?](https://www.tiktok.com/@jagwartwin/video/7417905979863420203) _Witness/Surveil_
- `2024-07-11` [Do you remember? ANGLE OF ETERNITY comes out tomorrow 📐♾️ @lovelytheband](https://www.tiktok.com/@jagwartwin/video/7390198261530791211)
- `2024-06-19` [Life is Good… in Brussels fr 🇧🇪 @angelbaby](https://www.tiktok.com/@jagwartwin/video/7382334709646249262)
- `2024-05-11` [Trust yourself and dreams come true](https://www.tiktok.com/@jagwartwin/video/7367875969220365614) _Sleep/WakeUp_
- `2024-04-18` [Replying to @TabbyCat I see it, except I dont randomly fall asleep 😴](https://www.tiktok.com/@jagwartwin/video/7359296091122175274)
- `2024-02-22` [The illusion of two choices](https://www.tiktok.com/@jagwartwin/video/7338487957407419690) _Gnosticism_
- `2024-01-07` [Replying to @diamond1 - MXES’ fan ⟡ 🍉 fan ⟡ 🍉 wake up Neo…](https://www.tiktok.com/@jagwartwin/video/7321464408146873646) _Sleep/WakeUp, WakeUp(Matrix)_
- `2023-12-04` [Replying to @benieandthejets1 I’m a god 🌈](https://www.tiktok.com/@jagwartwin/video/7308828336950889774) ✅ Extra check - another rejection of labels but then applies one himself "i'm a god"
- `2023-11-27` [This is beyond… god gives us the lessons we need. I needed to learn this difficult lesson of trusting myself, and b](https://www.tiktok.com/@jagwartwin/video/7306202726935825706) _Sleep/WakeUp_
- `2023-11-07` [“life is good” with @angelbaby is !](https://www.tiktok.com/@jagwartwin/video/7298807558658149662)
- `2023-07-31` [The Circle will grow ⭕️ The Circle (0) -](https://www.tiktok.com/@jagwartwin/video/7262032908809145646)
- `2023-07-17` [City of Angels - End/Beginning 34.052235, -118.243683 5.26.23](https://www.tiktok.com/@jagwartwin/video/7256841304112434478)✅ Extra check on this one because what are those numbers? coordinates? dewy decimal?  
- `2023-05-23` [I actually like snakes](https://www.tiktok.com/@jagwartwin/video/7236175561813396778)
- `2023-03-24` [I made a magic wand and went to the club](https://www.tiktok.com/@jagwartwin/video/7213955657001897262)
- `2023-03-14` [Follow the white rabbit 🐇](https://www.tiktok.com/@jagwartwin/video/7210195945735195946) _SirRabbit/Lucius_
- `2022-12-13` [Have you ever got a tattoo with someone you just met or is it just me and Cal? Watch the full episode of The Mirror](https://www.tiktok.com/@jagwartwin/video/7176685938389683499) _The Mirror_
- `2022-08-17` [“Everything is possible” - El Roy 🫠🕊](https://www.tiktok.com/@jagwartwin/video/7132972685688180014) _Roy_

## F. TikTok FLAG keepers — your ✅ only (3)
- `2026-01-07` [“For now we see through a glass, darkly” the Apostle Paul](https://www.tiktok.com/@jagwartwin/video/7592674336499158302) _The Circus_ ✅
- `2025-10-01` [The Interview EP 2 (The Rise of sir lucius) ROY believes in his , but after failures in the past, doubt lingers. si](https://www.tiktok.com/@jagwartwin/video/7556307270112382263) _Lucius_✅
- `2025-01-06` [Sleeping Beauty got codes](https://www.tiktok.com/@jagwartwin/video/7456923147388914975) ✅  - watch and transcribe if you can  → **transcribed** [[Sources/Transcripts/Roy TikTok - Sleeping Beauty decode (2025-01)]]

## Answers (resolved 2026-07-15)
1. **LOOP-visualizer war sequence:** grouped as one unit of 4 (08-07 added), watched, see §A. The "not Roy guy" is a **bad 2025 AI render of Roy**, not a character.
2. **Watch the videos:** capability confirmed; war sequence watched, rest deferred ("just the sequence for now"), recorded from Jen's notes.
3. **KEEP-A + KEEP-B: both kept in full** and now listed above as §C/§D.
4. **TikTok reviewed (Jen 2026-07-16):** §E pruned to 49 keepers (49 ❌ removed; the 2 ✅ are extra high-value); §F kept only the 3 ✅. Sleeping Beauty ✅ transcribed → Sources/Transcripts.

## Notes
- Dedup vs YT is by normalized caption core; a few near-dups with promo tails may leak (e.g. "There is only now… watch the full video on YouTube" is a TikTok echo of a YT ✅ item).
- TikTok reply-videos ("Replying to @user …") are a TikTok-native class, several are quote-cards (Gurdjieff etc.).
- The clipped McGonagall URL (2025-02-21) recovered: https://www.youtube.com/shorts/6FYRse0dCaI (offer stands to patch the Phase-1 file).
- Sources: `channel_bucketed.json` (YT) + `tiktok_unique.json` (TikTok) in the session scratchpad; TikTok feed = `Sources/Artifacts/Data/JT TikTok Feed - jagwartwin captions 2026-06-27.tsv`.