...
- **2026-07-29** — Jen, on the `t20` TikTok (2026-05-31, `@elroyjagwar`, *"Gratitude beam for @MERCY"*), correcting a **mis-filing by Claude**: ***"the mercy stuff is not private or secret, he said it on tiktok. it is also not very useful to the archive… the personal stuff not as much so it doesn't have to be added to the site at all."*** **This was never a boundary question and should not have been logged as one.** A public TikTok on Roy's own account is simply **public** under §What's public; no clearance was required and none is recorded. ★ **The operative axis is EDITORIAL RELEVANCE, not privacy** — the relationship detail is declined because it does not earn a place in an analytical archive, not because it is sensitive. Not folded to SOURCE, not going to the public site. **The distinction Jen drew, which is the reusable part:** within the same gratitude-video genre, *"the ones that give historical stories… thats useful"* (Matt Wallace producing Eye Alaska's first album; Chain Reaction; how Bhasker happened; the Joni ↔ Happy Face link) and the purely personal ones are not. **Filing lesson:** an over-cautious boundary guard on public material reads as rigor while actually mis-routing the question — the same shape as [[feedback_check_tradition_before_guarding]]. Ask "does this earn a place?" before "am I allowed?" The [[CLAUDE]] §"not a symbolic figure" guard on MERCY stands on its own merits and is unaffected.
